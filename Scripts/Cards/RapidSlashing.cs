...
public class RapidSlashing : ModCardTemplate
{
    // 基础耗能
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars => [
        ...
        new IntVar("Threshold", 4m),   // 初始阈值 4 次

    ];

    public RapidSlashing() : base(energyCost, type, rarity, targetType, shouldShowInCardLibrary)
    {
    }
    ...
    protected override void OnUpgrade()
    {
        ...
        DynamicVars["Threshold"].UpgradeValueBy(-1m); // 从 4 降到 3
    }
}