...
// 白兰地：0费生成技能牌，基酒。右键循环切换模式：自己 -> 敌人 -> 友方。
// 效果：对敌人造成3点伤害并施加1层虚弱；对自己/友方造成1点穿透伤害后获得3层临时敏捷。升级后伤害+3。
[RegisterCard(typeof(TokenCardPool))]
public class Brandy : ModCardTemplate, IModRightClickableCard, IBaseSpiritCard, ISpiritModeCard
{
    ...
    protected override IEnumerable<IHoverTip> AdditionalHoverTips => new[]
    {
        ...
        // 预览对应的鸡尾酒牌
        HoverTipFactory.FromCard<Sidecar>()
    };
    ...
    public Brandy() : base(energyCost, CardType.Skill, rarity, TargetType.Self, shouldShowInCardLibrary)
    {
    }
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        switch (_mode)
        {
            case SpiritMode.Self:
                ...
                await PowerCmd.Apply<SpeedPotionPower>(choiceContext, base.Owner.Creature, 3,
            ...
            case SpiritMode.Ally:
                ...
                await CreatureCmd.Damage(choiceContext, cardPlay.Target!, 1,
                    ValueProp.Unblockable | ValueProp.Unpowered, null, null);
                // 获得 3 层临时敏捷（直接使用速度药水的 SpeedPotionPower，回合结束失去等量敏捷）
                await PowerCmd.Apply<SpeedPotionPower>(choiceContext, cardPlay.Target, 3,
                    base.Owner.Creature, this);
