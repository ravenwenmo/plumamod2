...
public class Whiskey : ModCardTemplate, IModRightClickableCard, IBaseSpiritCard, ISpiritModeCard
{
    ...
    protected override IEnumerable<IHoverTip> AdditionalHoverTips => new[]
    {
        ...
        // 预览对应的鸡尾酒牌
        HoverTipFactory.FromCard<OldFashioned>()
    };
    ...
    public Whiskey() : base(energyCost, CardType.Skill, rarity, TargetType.Self, shouldShowInCardLibrary)
    {
    }
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        switch (_mode)
        {
            case SpiritMode.Self:
                ...
                // 获得 3 层覆甲
                await PowerCmd.Apply<PlatingPower>(choiceContext, base.Owner.Creature, 5,
            ...
            case SpiritMode.Ally:
                ...
                await CreatureCmd.Damage(choiceContext, cardPlay.Target!, 1,
                    ValueProp.Unblockable | ValueProp.Unpowered, null, null);
                // 获得 3 层覆甲
                await PowerCmd.Apply<PlatingPower>(choiceContext, cardPlay.Target, 5,
                    base.Owner.Creature, this);
