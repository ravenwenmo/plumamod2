...
public class Rum : ModCardTemplate, IModRightClickableCard, IBaseSpiritCard, ISpiritModeCard
{
    ...
    public Rum() : base(energyCost, CardType.Skill, rarity, TargetType.Self, shouldShowInCardLibrary)
    {
    }
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        switch (_mode)
        {
            case SpiritMode.Self:
                ...
                // 获得 2 层渐入佳境
                await PowerCmd.Apply<FlowState>(choiceContext, base.Owner.Creature, 3,
            ...
            case SpiritMode.Ally:
                ...
                await CreatureCmd.Damage(choiceContext, cardPlay.Target!, 1,
                    ValueProp.Unblockable | ValueProp.Unpowered, null, null);
                // 获得 2 层渐入佳境
                await PowerCmd.Apply<FlowState>(choiceContext, cardPlay.Target, 3,
                    base.Owner.Creature, this);
