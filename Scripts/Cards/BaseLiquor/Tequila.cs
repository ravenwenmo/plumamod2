...
public class Tequila : ModCardTemplate, IModRightClickableCard, IBaseSpiritCard, ISpiritModeCard, IBaseSpiritRelatedCard
{
    ...
    protected override IEnumerable<IHoverTip> AdditionalHoverTips => new[]
    {
        ...
        // 预览对应的鸡尾酒牌
        SpiritModeHoverPreview.FromCard<Margarita>(CurrentSpiritBranch)
    };
