...
public class Charging : ModCardTemplate
{
    ...
    public Charging() : base(energyCost, type, rarity, targetType, shouldShowInCardLibrary)
    {
    }
    ...
    {
        await PowerCmd.Apply<ChargingPower>(choiceContext, base.Owner.Creature, 1, base.Owner.Creature, this);
    }
    // 升级后的效果逻辑
