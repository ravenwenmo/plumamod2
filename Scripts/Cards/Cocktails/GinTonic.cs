...
// 金汤力：0费生成技能牌，鸡尾酒。右键循环切换模式：自己 -> 敌人 -> 友方。
// 效果：对敌人造成6点伤害并施加1层虚弱；对自己/友方造成1点穿透伤害后获得1层力量。升级后伤害+3并获得保留。
[RegisterCard(typeof(TokenCardPool))]
public class GinTonic : ModCardTemplate, IModRightClickableCard
{
    ...
    public GinTonic() : base(energyCost, CardType.Skill, rarity, TargetType.Self, shouldShowInCardLibrary)
    {
    }
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        switch (_mode)
        {
            case SpiritMode.Self:
                ...
                // 获得 1 层力量
                await PowerCmd.Apply<StrengthPower>(choiceContext, base.Owner.Creature, 1,
            ...
            case SpiritMode.Ally:
                ...
                await CreatureCmd.Damage(choiceContext, cardPlay.Target!, 1,
                    ValueProp.Unblockable | ValueProp.Unpowered, null, null);
                // 获得 1 层力量
                await PowerCmd.Apply<StrengthPower>(choiceContext, cardPlay.Target, 1,
                    base.Owner.Creature, this);
